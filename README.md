...
## Методика
Задержка считается как время, прошедшее от конца вызова функции DirectInput, содержащей команду на импульс, до момента, когда полученное значения угла поворота вала базы превысило заданный Порог.
...
Среднюю скорость считается за последние 25% промежутка отрезка: от начала движения по Порогу до конца Импульса.
