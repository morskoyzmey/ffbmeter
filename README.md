...
Если зеленый график имеет видимый прогиб где-то в середине импульса - вероятно у вас люфт где-то в цепочке руль-вал. Как это? Сперва вал базы начал набирать скорость, а через пару миллисекунд, выбрав зазор люфтящего соединения, столкнулся с остальной частью системы, на которой покоится руль и разумеется замедлился. На квик-релиз можно намотать немного фум ленты, а возможно вам нужно протянуть болты вашего вала или штурвала.
