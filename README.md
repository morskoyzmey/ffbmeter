...
Если зеленый график имеет видимый прогиб где-то в середине импульса - вероятно у вас люфт где-то в цепочке руль-вал. Как это? Сперва вал базы начал набирать скорость, а через пару миллисекунд столкнулся с люфтом квик-релизом, на котором покоится руль и разумеется замедлился. На квик можно намотать немного фум ленты, а возможно вам нужно протянуть болты вашего вала или штурвала.
