...
### Общий график серии измерений
![Скриншот версии 0.2.2](example.png?v=022)
### Отдельное измерение
![Скриншот версии 0.2.2](example2.png?v=022)

## Параметры по умолчанию
- Импульс: 20 мс
- Сила: 100%
- Угол: 900° (диапазон в драйвере)
- Повторы: 10 (количество измерений)
...
Средняя скорость считается в промежутке +/- 1.5 мс от времени Импульса. К примеру, для Импульса 20 мс интервал будет 18.5 - 21.5 мс.
...
Если зеленый график имеет видимый прогиб где-то в середине импульса - вероятно у вас люфт где-то в цепочке руль-вал. Но убедитесь на отдельном графике измерения, что кривизна не связана с повторяющимися сырыми данными (оранжевые кружки) из-за джиттера USB, образующими горизонтальную площадку. Если же частота опроса равномерна и при этом прогиб есть и в сырых данных, то люфт действительно есть.  Как это? Сперва вал базы начал набирать скорость, а через пару миллисекунд, выбрав зазор люфтящего соединения, столкнулся с остальной частью системы, на которой покоится руль и разумеется замедлился. На квик-релиз можно намотать немного фум ленты, а возможно вам нужно протянуть болты вашего вала или штурвала.
...
--- --- -------  ------  ---------  ---------  ---------  ------
  1  +     6.82   0.010      55097       9183      134.8    4.95
  2  -     7.88   0.019      57339       9556      128.0    4.47
  3  +     7.81   0.019      56984       9497      127.7    4.41
  4  -     7.83   0.015      55629       9271      124.4    4.25
  5  +     6.93   0.020      56544       9424      137.3    5.19
  6  -     7.84   0.010      54171       9029      123.3    4.22
  7  +     6.94   0.014      56025       9338      133.7    4.72
  8  -     6.79   0.012      57950       9658      139.7    5.36
  9  +     7.83   0.022      58526       9754      131.1    4.50
 10  -     7.87   0.020      56085       9347      127.4    4.53
--- --- -------  ------  ---------  ---------  ---------  ------
Ср.        7.45   0.016      56435       9406      130.7    4.66
```
![Скриншот версии 0.2.2](example.png?v=022)
